...
<input class=" form-control " aria-describedby="basic-addon1"  style="text-align: center;" type="number" name="searchv" autofocus  placeholder="البحث عن العناصر "  >
...
header( "Refresh:30;url=http://localhost/out/search.php" ); 
